  ...
  return (
    <section className="sec" id="rent">
      <div className="wrap grid rent2">
        <figure className="rent-fig" data-reveal="image">
          <img className="ph" src={HOME_IMAGES.rent.src} alt={HOME_IMAGES.rent.alt} decoding="async" loading="lazy" />
          <figcaption className="mono muted">Travel light — 필요한 기간만, 가볍게.</figcaption>
        </figure>
        <div className="rent-txt">
          <div className="rent-l" data-reveal>
          ...
          <ul className="rent-r" data-reveal="stagger">
